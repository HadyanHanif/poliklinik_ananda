...
// Query untuk mengambil data dari tabel dokter dan nama poli
$sql = "SELECT dokter.id, dokter.nama, dokter.password, dokter.no_hp, dokter.id_poli, poli.nama_poli 
        FROM dokter
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 sidebar vh-100 d-flex flex-column p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="kelola_dokter.php">Kelola Dokter</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-9 col-lg-10 d-flex flex-column p-5">
                <h2 class="fw-bold mb-4">Kelola Dokter</h2>
                    ...
                    <table class="table table-bordered table-hover align-middle">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th>Password</th>
                                <th>ID Poli</th>
                                <th>Nama Poli</th> <!-- Kolom Nama Poli ditambahkan -->
                                <th>Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                            ...
                                            <a href='hapus_dokter.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");'>Delete</a>
                                          </td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='6' class='text-center'>Tidak ada data</td></tr>"; // Ubah colspan menjadi 6 karena ada tambahan kolom
                            }
                            ?>
                        </tbody>
                    </table>
