...
INSERT INTO `dokter` (`id`, `nama`, `password`, `no_hp`, `id_poli`) VALUES
(4, 'Dr. Andi', '12345', 812, 1),
(5, 'dika', '11', 812, 2),
(6, 'hardi', '234', 2564, 2);
...
(2, 'Paramex', 'Tablet', 5000),
(3, 'Sakatonik ABC', 'Tablet', 30000),
(4, 'OBH Combi', 'Cair', 20000);
...
(7, 'ayu', '12345', 'semarang', 123456, 8125933, '202412-001'),
(8, 'Andi', '255', 'semarang', 1234, 1111, '202412-002'),
(12, 'Chintya', '123456', 'Tangerang', 88687, 235235, '202412-003');
...
(1, 'Poli Gigi', 'Melakukan pemeriksaan gigi'),
(2, 'Poli Anak', 'Melakukan pemeriksaan pada anak');
