        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 sidebar vh-100 d-flex flex-column p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="kelola_poli.php">Kelola Poli</a>
                    </li>
                </ul>
            </div>
            
            <div class="col-md-9 col-lg-10 d-flex flex-column p-5">
                <h2 class="fw-bold mb-4">Kelola Poli</h2>
                
                <!-- Button Tambah Poli -->
                <div class="mb-4">
                    <a href="tambah_poli.php" class="btn btn-primary">Tambah Poli</a>
                </div>

                <!-- Table untuk menampilkan data poli -->
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                            ...
                                            <a href='hapus_poli.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");'>Delete</a>
                                          </td>";
                                    echo "</tr>";
                                }
                            } else {
